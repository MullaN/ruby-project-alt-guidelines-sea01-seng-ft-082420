...
s1 = Student.create(name: "Taylor", age: "4", contact_info: "taylor@ausd.com")
s2 = Student.create(name: "Brooks", age: "5", contact_info: "brooks@ausd.com")
s3 = Student.create(name: "Chloe", age: "6", contact_info: "chloe@ausd.com")
s4 = Student.create(name: "Coen", age: "5", contact_info: "coen@ausd.com")
s5 = Student.create(name: "Rhea", age: "7", contact_info: "rhea@ausd.com")


Classroom.create(name: "Science", student_id: s1.id, teacher_id: t2.id)
Classroom.create(name: "Science", student_id: s5.id, teacher_id: t2.id)
Classroom.create(name: "Art", student_id: s2.id, teacher_id: t1.id)
Classroom.create(name: "Art", student_id: s4.id, teacher_id: t2.id)
